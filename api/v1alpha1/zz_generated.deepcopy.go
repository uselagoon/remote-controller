...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LagoonBuildInfo) DeepCopyInto(out *LagoonBuildInfo) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LagoonBuildInfo.
func (in *LagoonBuildInfo) DeepCopy() *LagoonBuildInfo {
	if in == nil {
		return nil
	}
	out := new(LagoonBuildInfo)
	in.DeepCopyInto(out)
	return out
}
