...
func (m *Messenger) HarborPolicy(ctx context.Context, jobSpec *lagoonv1beta1.LagoonTaskSpec) error {
...
func (m *Messenger) generateRetentionPolicy(projectID int64, projectName string, policy HarborRetentionPolicy) (*harborclientv5model.RetentionPolicy, error) {
	...
	schedule, err := helpers.ConvertCrontab(projectName, policy.Schedule)
	if err != nil {
