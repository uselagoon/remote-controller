...
var (
	...
	projectRepositoriesWant = `[{"artifact_count":1,"name":"nginx-example/dev3/nginx","pull_count":0},{"artifact_count":1,"name":"nginx-example/dev2/nginx","pull_count":0},{"artifact_count":1,"name":"nginx-example/dev1/nginx","pull_count":1},{"artifact_count":1,"name":"nginx-example/main/nginx","pull_count":1}]`
)
